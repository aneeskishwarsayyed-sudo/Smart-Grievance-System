            ...
            <div style={styles.benefitsSection}>
              <div style={styles.benefitRow}>
                ...
                <div style={styles.benefitText}>
                  <h3 style={styles.benefitTitle}>Easy Registration</h3>
                  <p style={styles.benefitDesc}>Quick and simple account setup process</p>
                </div>
              </div>
              ...
              <div style={styles.benefitRow}>
                <div style={styles.benefitDot}></div>
                <div style={styles.benefitText}>
                  <h3 style={styles.benefitTitle}>Secure Access</h3>
                  <p style={styles.benefitDesc}>Your data is protected with encryption</p>
                </div>
              </div>
              ...
              <div style={styles.benefitRow}>
                <div style={styles.benefitDot}></div>
                <div style={styles.benefitText}>
                  <h3 style={styles.benefitTitle}>Start Now</h3>
                  <p style={styles.benefitDesc}>Begin submitting complaints immediately</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div style={styles.rightSection}>
          <div style={styles.formCard}>
            <div style={styles.formHeader}>
              ...
              <p style={styles.formSubtitle}>Join ResolveIT today</p>
            </div>
